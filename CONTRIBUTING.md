Contributing to MBMB Core
============================

The MBMB Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MBMB Core project, and is not to be
confused with overall MBMB Network Protocol consensus changes.

Whether a pull request is merged into MBMB Core rests with the project merge
...
Patches that change MBMB consensus rules are considerably more involved than
...
Where a patch set proposes to change the MBMB consensus, it must have been
...
The project leader is the release manager for each MBMB Core release.
