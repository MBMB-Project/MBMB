...
#   c) node1 mines 32 blocks, so now node 0 has 60001mbmb, node 1 has 4250mbmb, node2 has none.
#   d) node0 sends 601 mbmb to node2, in two transactions (301 mbmb, then 300 mbmb).
