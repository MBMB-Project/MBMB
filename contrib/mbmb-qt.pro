...
RESOURCES += src/qt/mbmb.qrc src/qt/mbmb_locale.qrc

TRANSLATIONS += src/qt/locale/mbmb_bg.ts \
                src/qt/locale/mbmb_de.ts \
                src/qt/locale/mbmb_en.ts \
                src/qt/locale/mbmb_es.ts \
                src/qt/locale/mbmb_fi.ts \
                src/qt/locale/mbmb_fr.ts \
                src/qt/locale/mbmb_it.ts \
                src/qt/locale/mbmb_ja.ts \
                src/qt/locale/mbmb_pl.ts \
                src/qt/locale/mbmb_pt.ts \
                src/qt/locale/mbmb_ru.ts \
                src/qt/locale/mbmb_sk.ts \
                src/qt/locale/mbmb_sv.ts \
                src/qt/locale/mbmb_vi.ts \
                src/qt/locale/mbmb_zh_CN.ts \
                src/qt/locale/mbmb_zh_TW.ts
