...
In order to support loading of multiple wallets in mbmb-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mbmb.cpp.
...
Changes to mbmb.cpp
----------------------
mbmb.cpp is the entry point into mbmb-qt, and as such, will require some minor modifications to provide hooks for
