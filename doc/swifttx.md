...
This mechanism has been integrated into Bitcore-Node-MBMB which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MBMB-Project/insight-api-mbmb#web-socket-api](https://github.com/MBMB-Project/insight-api-mbmb#web-socket-api) 
* API: [https://github.com/MBMB-Project/insight-api-mbmb#swifttx-transactions](https://github.com/MBMB-Project/insight-api-mbmb#swifttx-transactions) 
...
By default, the MBMB Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MBMB Core daemon:
