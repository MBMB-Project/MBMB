...
/* MBMB GUI -- Size of icons in status bar */
...
#define COLOR_STAKE QColor(0, 119, 215)
...
#define QAPP_ORG_NAME "MBMB"
#define QAPP_ORG_DOMAIN "mbmb.org"
#define QAPP_APP_NAME_DEFAULT "MBMB-Qt"
#define QAPP_APP_NAME_TESTNET "MBMB-Qt-testnet"
