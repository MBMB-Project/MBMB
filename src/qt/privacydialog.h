...
public:
    ...
    void setZMbmbControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzMBMB_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMBMB_clicked();
    void on_pushButtonZMbmbControl_clicked();
