...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MBMB Core mbmb-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mbmb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mbmb transaction") + "\n" +
                               "  mbmb-tx [options] -create [commands]   " + _("Create hex-encoded mbmb transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mbmb transaction
